        ...
        <div className="qm-root">
            {loading ? (
                ...
                <div className="qm-card">
                    ...
                    <div className="qm-table-wrap" style={{ background: '#fff', borderRadius: '24px', border: '1px solid #e2e8f0', overflow: 'hidden', boxShadow: '0 4px 16px rgba(0,0,0,0.06)' }}>
                        <table className="qm-table" style={{ width: '100%', borderCollapse: 'collapse' }}>
                            <thead>
                                <tr style={{ background: 'linear-gradient(135deg, #0f172a 0%, #1e293b 100%)' }}>
                                    <th style={{ padding: '1.125rem 1.5rem', textAlign: 'left', fontSize: '0.7rem', fontWeight: 700, color: '#94a3b8', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Identifier</th>
                                    <th style={{ padding: '1.125rem 1.5rem', textAlign: 'left', fontSize: '0.7rem', fontWeight: 700, color: '#94a3b8', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Client Receiver</th>
                                    <th style={{ padding: '1.125rem 1.5rem', textAlign: 'left', fontSize: '0.7rem', fontWeight: 700, color: '#94a3b8', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Project</th>
                                    <th style={{ padding: '1.125rem 1.5rem', textAlign: 'right', fontSize: '0.7rem', fontWeight: 700, color: '#94a3b8', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Final Sum</th>
                                    <th style={{ padding: '1.125rem 1.5rem', textAlign: 'left', fontSize: '0.7rem', fontWeight: 700, color: '#94a3b8', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Generated By</th>
                            ...
                            <tbody>
                                {filtered.map(q => (
                                    <tr key={q._id} style={{ borderBottom: '1px solid #f1f5f9', transition: 'all 0.2s ease' }}
                                        ...
                                        <td style={{ padding: '1.125rem 1.5rem' }}>
                                            {q.projectId ? (
                                                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                                                    ...
                                                    <span style={{ fontSize: '0.85rem', color: '#475569', fontWeight: 600 }}>{q.projectId.name || 'N/A'}</span>
                                                </div>
                                        ...
                                        <td style={{ padding: '1.125rem 1.5rem' }}>
                                            <div className="qm-table-actions" style={{ display: 'flex', gap: '0.375rem', justifyContent: 'center' }}>
                                                <motion.button whileTap={{ scale: 0.95 }} onClick={() => setViewQuotation(q)} style={{ background: '#f8fafc', border: '1.5px solid #e2e8f0', borderRadius: '10px', width: 36, height: 36, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#475569' }}><Printer size={14} /></motion.button>
                                                <motion.button whileTap={{ scale: 0.95 }} onClick={() => openDeleteModal(q)} style={{ background: '#fef2f2', border: '1.5px solid #fee2e2', borderRadius: '10px', width: 36, height: 36, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#ef4444' }}><Trash2 size={14} /></motion.button>
                                            </div>
                                        </td>
                                    </tr>
                                ))}
                                {filtered.length === 0 && <tr><td colSpan="6"><div className="qm-empty" style={{ padding: '2rem', textAlign: 'center', color: '#94a3b8' }}>No templates in active registry</div></td></tr>}
                            </tbody>
                        </table>
                    </div>
                </div>
